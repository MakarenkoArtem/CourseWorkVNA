# Constants for calibration states
CALIBRATED = 0
...
class SettingsModel:
    ...
    def fromForm(self, form):
        mapp = {
            "freq_start_mhz.data": "freq_start_mhz",
            "freq_stop_mhz.data": "freq_stop_mhz",
            "num_freq_points.data": "num_freq_points",
            "rbw_khz.data": "rbw_khz",
            "output_power_dbm.data": "output_power_dbm",
            "txtr.data": "txtr",
            "mode.data": "mode",
        }
    ...
    def toForm(self, form):
        mapp = {
            "freq_start_mhz": "freq_start_mhz.data",
            "freq_stop_mhz": "freq_stop_mhz.data",
            "num_freq_points": "num_freq_points.data",
            "rbw_khz": "rbw_khz.data",
            "output_power_dbm": "output_power_dbm.data",
            "txtr": "txtr.data",
            "mode": "mode.data",
        }
